<template>
  <div class="app-toolbar">
    ...
    <transition name="app-toolbar-item-navigator">
      <div class="app-toolbar-item naviator" v-if="showPostShowNaviagor">
        <PostShowNavigator />
      </div>
    </transition>
...
export default defineComponent({
  ...
  computed: {
    ...mapGetters({
      ...
      showPostShowNaviagor: 'toolbar/showPostShowNavigator',
   ...
   * 使用组件
   */
  components: { AppToolbarItemSideSheet, PostShowNavigator, AppToolbarItemSearch, PostListLayoutSwitcher },
});
</script>
